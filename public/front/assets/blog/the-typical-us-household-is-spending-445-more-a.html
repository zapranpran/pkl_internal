            ...
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-center in-blog-1 in-article">
                    <div class="uk-width-1-1 in-figure-available">
                        <img class="uk-width-1-1 uk-border-rounded" src="../img/user/image-featured-a4DfvV.jpg" alt="The typical U.S. household is spending $445 more a month due to inflation">
                    </div>
                    <div class="uk-width-3-4@m">
                        <article class="uk-card uk-card-default uk-border-rounded in-flat-rounded-top">
                            <div class="uk-card-body">
                                ...
                                <h2 class="uk-margin-top uk-margin-medium-bottom">The typical U.S. household is spending $445 more a month due to inflation</h2>
                                ...
                                <p>Consumer prices jumped by 8.2% in September versus the same month in 2021, the U.S. Bureau of Labor Statistics said Thursday. That rate is down from 9.1% in June, which marked the recent peak, but is still near the highest levels since the early 1980s.</p>
                                <p>Wages for many workers haven’t kept pace with inflation, meaning they’ve lost purchasing power. Hourly earnings fell 3%, on average, in the year to September after accounting for inflation, according to the bureau.</p>
                                <p>The inflation impact on households’ wallets isn’t uniform, though. Your personal inflation rate depends on the types of goods and services you buy, and other factors such as geography.</p>
                                <h4 class="uk-margin-small-bottom">There’s ‘no one silver bullet’ to save money</h4>
                                <p>Households can take certain steps to blunt the impact — and most are unlikely to feel good, according to financial advisors.</p>
                                <p>“There’s no one silver bullet,” said Joseph Bert, a certified financial planner who serves as chairman and CEO of Certified Financial Group. The firm, based in Altamonte Springs, Florida, ranked No. 95 on the 2022 CNBC Financial Advisor 100 list.</p>
                                <p>Fixed expenses are outlays for essentials such as a mortgage, rent, food, transit costs and insurance, for example. Discretionary costs include spending on, say, dining out or vacations — things people enjoy but don’t necessarily need.</p>
                                <p>There’s often less flexibility to cut fixed expenses, meaning nonessentials are the budget area where households likely have to make cuts if they want to save money, Maloon said.</p>
                            </div>
                            <div class="uk-card-footer uk-clearfix">
                                <div class="uk-float-left in-article-tags">
                                    ...
                                    <a href="../blog-find.html?tag=inflation" class="uk-link-muted">inflation</a>,&nbsp;
