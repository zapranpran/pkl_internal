                    ...
                    <div class="uk-width-3-4@m">
                        <article class="uk-card uk-card-default uk-border-rounded">
                            <div class="uk-card-body">
                                ...
                                <h2 class="uk-margin-top uk-margin-medium-bottom">Shortfalls of some cold and flu meds continue amid shifting respiratory virus season</h2>
                                <p>Experts say there will likely be a post-holiday bump in respiratory virus numbers, and that could put an even greater strain on supplies of some medications that have been hard to find amid a severe illness season.</p>
                                <p>Children’s pain and fever medications might be the toughest products to find. Pharmacies say high flu activity has also led to sporadic shortfalls of Tamiflu and some over-the-counter cold and flu medicine for adults. But supplies of Covid-19 home tests are plentiful, as those case numbers begin to rise again.</p>
                                <h4 class="uk-margin-small-bottom">Stores limit purchases</h4>
                                <p>The RSV season arrived early this year, and cases have dropped dramatically over the past month. But with the virus still making the rounds – along with the flu and Covid-19 – and children’s fever reducers and pain medicines are harder to come by in some places.</p>
                                <p>Pharmacies say they have seen greater demand, and some big chains are limiting purchases in order to make the most of the existing supply.</p>
                                <blockquote class="in-article-blockquote">
                                    <p class="uk-margin-small-bottom">Retailers nationwide are experiencing supplier fulfillment challenges due to increased demand of over-the-counter pediatric fever reducing products</p>
                                    <footer><cite>Walgreens spokesperson Fraser Engerman</cite></footer>
                                </blockquote>
                                <p>Walgreens instituted limits on children’s pain and fever medications last week and continues to limit customers to six packages per online transaction to “prevent excess purchasing behavior.” It doesn’t have a limit on store purchases.</p>
                                <h4 class="uk-margin-small-bottom">High flu activity means high demand</h4>
                                <p>Flu activity remains high across the US. There have been an estimated 18 million flu cases, 90,000 hospitalizations and 23,000 deaths this season, according to the US Centers for Disease Control and Prevention. By some metrics, it’s the worst flu season in a decade.</p>
                                <p>That’s led to greater demand for the medication oseltamivir, also known as Tamiflu, which can help ease and shorten flu symptoms.</p>
                                <p>Walgreens has seen isolated temporary shortages of Tamiflu, and suggests that people who have a prescription for the drug call their local pharmacy to make sure it’s available there before coming in to pick it up.</p>
                            </div>
                            <div class="uk-card-footer uk-clearfix">
                                <div class="uk-float-left in-article-tags">
                                    ...
                                    <a href="../blog-find.html?tag=virus" class="uk-link-muted">virus</a>
                                </div>
